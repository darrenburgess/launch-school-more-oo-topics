...
class ClockTest < Minitest::Test
  ...
  def test_subtract_minutes_less_than_hour
    clock = Clock.at(10) - 9
    assert_equal '09:51', clock.to_s
  end

  def test_subtract_minutes_less_than_hour2
    clock = Clock.at(10, 9) - 9
    assert_equal '10:00', clock.to_s
  end

  def test_subtract_minutes_less_than_hour3
    clock = Clock.at(10, 9) - 10
    assert_equal '09:59', clock.to_s
  end
